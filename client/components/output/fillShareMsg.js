...
function generateShareMessage(state, percentageDifference, percentile){
  ...
  const msgFull = `${msgIntro} in ${genderPossessive} ${age} earns ${percentDiffClean} than a ${inverseGender}. Find yr pay gap @FT https://ig.ft.com/gender-pay-gap-calculator`;
